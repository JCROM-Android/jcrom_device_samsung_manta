...
MAGURO_BLOBS="audience-manta-1537103-8f1a4c56.tgz
              broadcom-manta-1537103-15b8bdff.tgz
              samsung-manta-1537103-bcd253ac.tgz"

CSUM_LIST="$PWD/blob-shasums"

cd ../../.. &&
install_blobs nexus-10 "$MAGURO_BLOBS" "$CSUM_LIST"
